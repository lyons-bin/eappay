...
class dinpay_plugin
{
	...
	static private function handleProfits(&$params){
		...
		if($psreceiver){
			...
			$params['splitRules'] = json_encode([[
				'splitBillMerchantNo' => $psreceiver['account'],
				'splitBillAmount' => $psmoney,
				'splitBillRequestNo' => TRADE_NO.$psreceiver['id'],
			]]);
		}
	}
