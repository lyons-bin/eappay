...
class fuiou2_plugin
{
	...
	static public function submit(){
		...
		if($order['typename']=='alipay'){
			...
			}elseif(checkmobile() && !checkwechat() && $channel['appwxa']>0){
	...
	static public function mapi(){
		...
		if($method=='jsapi' && $order['typename']=='alipay'){
			return self::alipayjs();
		}elseif($method=='jsapi' && $order['typename']=='wxpay'){
			return self::wxjspay();
		}elseif($method=='scan'){
			return self::scanpay();
			...
			}elseif($device=='mobile' && $mdevice!='wechat' && $channel['appwxa']>0){
	...
	static public function refund($order){
		...
		$param = [
			'mchnt_order_no' => $channel['api_trade_no'],
