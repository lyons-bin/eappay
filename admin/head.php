    ...
    <div class="container">
      ...
      <div id="navbar" class="collapse navbar-collapse">
        ...
        <li><a href="./set_wxkf.php">H5跳转微信客服支付</a></li>
		  ...
		  <li class="<?php echo checkIfActive('clean,log,transfer,transfer_add,risk,export,ps_receiver,ps_order,gettoken,blacklist,complain,complain_info,buyerstat')?>">
        ...
        <li><a href="./export.php">导出订单</a><li>
			  <li><a href="./transfer_add.php">转账付款</a><li>
